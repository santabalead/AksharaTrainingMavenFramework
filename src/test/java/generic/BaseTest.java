...
public class BaseTest {
	...
	// As per coding standards all the final variable can be written in capital letters see above blue
	
	public WebDriver driver;//If we make it static then parallel execution is not possible
